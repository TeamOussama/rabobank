...
public class GlobalExceptionHandler {
    ...
    private ResponseEntity<String> handleApiException(HttpException httpException) {
        return new ResponseEntity(httpException.getMessage(), httpException.getHttpStatus());
    }

    private ResponseEntity<String> handleValidationException(MethodArgumentNotValidException exception) {
    ...
    private ResponseEntity<String> handleUnexpectedException() {
