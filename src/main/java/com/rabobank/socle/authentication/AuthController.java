...
import com.rabobank.socle.authentication.resetpassword.*;
...
public class AuthController {
    ...
    @Transactional
    public ResponseEntity<ResponseMessage> requestPassword(
        @Valid @RequestBody RequestPasswordDTO requestPasswordDTO) {
